            ...
            {pins && pins.length > 0 && (
              <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {pins.flatMap(pin => pin.photos || []).slice(0, 6).map((photo, index) => (
          ...
          <div>
            ...
            <Card>
              <CardContent className="p-6">
                <h2 className="text-lg font-medium text-neutral-800 mb-4">Trip Timeline</h2>
                ...
                {pins && pins.length > 0 ? (
                  ...
                  <p className="text-neutral-500 text-center py-4">No locations added to this trip yet.</p>
                )}
              </CardContent>
            </Card>
          </div>
